...
function Dashboard() {
  return (
    <div className=' p-6 lg:pt-0 lg:pr-10 lg:pb-0 lg:pl-0 md:flex  min-h-screen'>

      <Sidebar />

      <div className=' md:min-w-[86%] lg:p-16 flex flex-col'>
        ...
        <div className=' flex min-h-[15vh] border-b border-gray-100 justify-center items-center mt-9 '>
        ...
        <div className=' flex pb-4 items-center mt-9'>
        ...
        <div className=' flex justify-between pt-4 pb-4'>
          <Link><h2 className=' text-sm lg:text-xl'>Recent</h2></Link>
          <Link><h2 className=' text-sm lg:text-xl'>View all</h2></Link>
        </div>
